...
try {
    while (cursor.hasNext()) {
        ...
        jRadioButton2.setText((String)d.get("Answer"));
...
try {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("William Jones");
        ...
        jRadioButton2.setText("Rasmas Lerdorf");
        ...
        jRadioButton3.setText("C F Codd");
        ...
        jRadioButton4.setText("Stephen Kwolek ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jRadioButton2.isSelected()==true)
            ...
            LastPage lp=new LastPage(score);
            lp.setVisible(true);
            this.dispose();
